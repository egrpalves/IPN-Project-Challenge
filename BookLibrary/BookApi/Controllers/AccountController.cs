...
using BookApi.Providers;
using BookApi.Results;
...
namespace BookApi.Controllers
{
    ...
    public class AccountController : BaseApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var role = (from r in db.Roles where r.Name == model.RoleName select r.Name).FirstOrDefault();
            ...
            {
                var userId = (from u in db.Users where u.UserName == model.Email select u.Id).FirstOrDefault();
